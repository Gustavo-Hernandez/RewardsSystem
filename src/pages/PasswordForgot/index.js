  ...
  return (
    ...
    <div className="row">
      <div className="l-panel col-md-7">
            ...
            <br/>
            <p>Ingresa tu correo electrónico con el que registraste tu cuenta, <br/>
            Enviarémos un correo de recuperación</p>
            
            <form>
               <div className="mb-3">
                  <input type="email" className="form-control" value={email} onChange={handleEmailChange} id="InputEmailC1" aria-describedby="emailHelp" placeholder="Ingresa tu e-mail"/>
               </div>
               <br/>
               <div className="row">
