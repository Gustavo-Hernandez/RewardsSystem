  ...
  return (
    <div className='row'>
      <div className='l-panel col-md-7'>
        ...
        <br />
        <p>
          Inicia sesión con tu cuenta y registra <br />
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='row'>
            ...
            <div className='col-3 iniSesion'>
              <p>
                ó <Link to='/register'>Crea una nueva cuenta</Link>
              </p>
            </div>
          </div>
          <div>
            <br />
            <p>
              <Link to='/password-forgot'>Olvidé mi contraseña</Link>
            </p>
          </div>
        </form>
